...
async def classify_intent_node(state: ConversationState):
    ...
    - alert_query: Questions starting with 'what if', or asking about alerts, simulations, festivals
    ...
    intent_match = re.search(r"(sales_query|pricing_query|inventory|forecast|image_analysis|alert_query|general_chat)", response.content)
